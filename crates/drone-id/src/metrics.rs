...
//! overall accuracy and macro-F1. All metrics are derived from a single
//! confusion matrix so they stay mutually consistent.
...
mod tests {
    ...
    fn confusion_and_per_class_are_consistent() {
        ...
        // class 0 precision = TP/(TP+FP) = 2/(2+1) = 0.666...
        assert!((r.per_class[0].precision - 2.0 / 3.0).abs() < 1e-5);
        // class 0 recall = 2/2 = 1.0
        ...
        // macro-F1 is the mean of the two class F1s.
